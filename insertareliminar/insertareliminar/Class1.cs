...
namespace insertareliminar
{
    class Class1
    {
        private SqlConnection conexion = new SqlConnection("Data Source = DESKTOP-9LD220N\\SQLEXPRESS; Initial Catalog = desarrolo; Integrated Security = true");
        private DataSet ds;

        public DataTable MostrarDatos()
        {
            conexion.Open();
            SqlCommand cmd = new SqlCommand("select id,nombre,genero,descripcion,foto,categoria_edad from juegos where estado=1", conexion);
